...
func (srv server) AppendEntries(ctx context.Context, request *pb.AppendEntriesRequest) (*pb.AppendEntriesResponse, error) {
	...
	result, err := executeRPC[*raft.AppendEntriesResponse](ctx, &command, nil, srv.nw.rpcCh)
	if err != nil {
		return nil, err
	}
...
func (srv server) AppendEntriesPipeline(s pb.RaftService_AppendEntriesPipelineServer) error {
	for {
		...
		resp, err := executeRPC[*raft.AppendEntriesResponse](s.Context(), &command, nil, srv.nw.rpcCh)
		if err != nil {
			return err
		}
...
func (srv server) RequestVote(ctx context.Context, request *pb.RequestVoteRequest) (*pb.RequestVoteResponse, error) {
	...
	result, err := executeRPC[*raft.RequestVoteResponse](ctx, &command, nil, srv.nw.rpcCh)
	if err != nil {
		return nil, err
	}
...
func (srv server) TimeoutNow(ctx context.Context, request *pb.TimeoutNowRequest) (*pb.TimeoutNowResponse, error) {
	...
	result, err := executeRPC[*raft.TimeoutNowResponse](ctx, &command, nil, srv.nw.rpcCh)
	if err != nil {
		return nil, err
	}
...
func (srv server) InstallSnapshot(stream pb.RaftService_InstallSnapshotServer) error {
	...
	result, err := executeRPC[*raft.InstallSnapshotResponse](ctx, &command, streamWrapper, srv.nw.rpcCh)
	if err != nil {
		return err
	}
